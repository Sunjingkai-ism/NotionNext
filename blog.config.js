...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'You must read more,get stronger,and emancipate yourself',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sunjingkai', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Read more and Emancipate yourself', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'emancipate.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Knowledge,books', // 网站关键词 英文逗号隔开
...
// START ************网站字体*****************
  // 使用 LXGW WenKai 作为默认字体
  FONT_STYLE: 'font-sans font-light',
  
  // 字体CSS 直接使用 LXGW WenKai 的网络字体链接
  FONT_URL: [
    'https://npm.elemecdn.com/lxgw-wenkai-webfont@1.6.0/style.css'
  ],
  
  // 无衬线字体，默认设为 LXGW WenKai
  FONT_SANS: [
    '"LXGW WenKai"',
    '-apple-system',
    'BlinkMacSystemFont',
